# Contributing to MyAIClasses

Thank you for your interest in contributing to MyAIClasses! This guide will help you get started and ensure a smooth collaboration.
...
| **New feature or architecture change** | Start a [GitHub Discussion](https://github.com/THU-MAIC/MyAIClasses/discussions) or ask in [Discord](https://discord.gg/PtZaaTbH) **before** opening a PR |
...
Use the [Bug Report](https://github.com/THU-MAIC/MyAIClasses/issues/new?template=bug_report.yml) issue template. Include:
...
Use the [Feature Request](https://github.com/THU-MAIC/MyAIClasses/issues/new?template=feature_request.yml) issue template. For larger features, please open a [Discussion](https://github.com/THU-MAIC/MyAIClasses/discussions) first.

## Security Vulnerabilities

Please report security vulnerabilities through [GitHub Security Advisories](https://github.com/THU-MAIC/MyAIClasses/security/advisories/new). **Do not** open a public issue for security vulnerabilities.

## License

By contributing to MyAIClasses, you agree that your contributions will be licensed under the [AGPL-3.0 License](LICENSE).
